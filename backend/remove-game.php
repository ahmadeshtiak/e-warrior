...
<body>
    ...
    <div class="container">
        <p class="text-center lead">Manage games from this dashboard.</p>
                        ...
                        <tbody>
                            ...
                            if (isset($games) && !empty($games)) {
                                foreach ($games as $game) {
                                    ...
                                    echo "<a href='rem-game.php?game_id=" . urlencode($game['game_id']) . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure you want to remove this game?\");'>";
                                ...
                                echo "<tr><td colspan='7' class='text-center'>No games found.</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
